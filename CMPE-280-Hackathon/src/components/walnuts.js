...
{lat: 39.007700, lng: -122.924705},
  ];
  

  const walnutProductionCentersIran = [
    {lat: 36.2620, lng: 59.6168}, //- Khorasan Razavi Province
    {lat: 36.3049, lng: 59.6161} ,//- Mashhad
    {lat: 36.6019, lng: 52.6723}, //- Semnan Province
    {lat: 34.0804, lng: 49.6850} ,//- Isfahan Province
    {lat: 35.5733, lng: 53.3743} ,//- Sari
    {lat: 36.6188, lng: 53.2105} ,//- Golestan Province
    {lat: 36.2970, lng: 59.3979} ,//- Neyshabur
    {lat: 32.6650, lng: 51.6776} ,//- Fars Province
